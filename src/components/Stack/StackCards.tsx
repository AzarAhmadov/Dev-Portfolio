...
const StackCards: FC<StackItem> = ({ item }) => {
    return (
        <li className='border-[1px] dark:text-white shadow-sm border-[#0000000f] dark:border-[#ffffff56] rounded-lg md:px-5 md:py-4 py-3 px-3 transition-all hover:bg-[#7372720f] hover:scale-105'>
