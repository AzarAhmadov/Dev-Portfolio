  ...
  return (
    <header className="py-6">
      <div className="flex justify-between items-center">
        <div>
          <span className="md:text-[16px] text-[14px] relative ps-7 pe-5 bg-aviable-bg text-green font-normal rounded-full py-2">
            Available for work
        ...
        <div>
          <ul className="flex gap-3">
            <li>
              <Link
                target="_blank"
                href={"https://www.linkedin.com/in/azar-ahmadov/"}
              >
                <CiLinkedin
                  aria-label="LinkedIn"
            ...
            <li>
              <Link
                target="_blank"
                href={"https://api.whatsapp.com/send?phone=9940558210637"}
              >
                <FaWhatsapp
                  aria-label="Whatsapp"
                  className="text-icons-bg dark:text-white dark:hover:text-[#ffffffc6] text-[30px] hover:text-black transition-all hover:scale-110"
