      ...
      <div className="pt-2 md:pt-5 flex justify-center items-center flex-col">
        ...
        <div className="text-center pt-3 md:px-[70px]">
          ...
          <p className="text-[13px] dark:text-[#ffffffd0]  leading-[20px] md:text-[17px] font-thin md:leading-[26px] text-gray">
            I currently reside in Baku. For about 4 years, I have been actively
            trying to improve my skills in the field of technology and
            constantly applying what I have learned. I had the opportunity to
            work in various technology companies, and I am pleased about that.
          </p>
        </div>
      </div>
      <div className="container flex flex-wrap justify-center md:justify-between gap-5 gap-x-8 md:gap-x-0 md:gap-0 pt-6 md:pt-[70px]">
        ...
        <div className="flex justify-center md:w-[33.3%]">
          <a
            aria-label="cv"
            download
            href="/cv/AzarAhmadov(cv,en).pdf"
            className="bg-gradient-to-l from-stone-800 to-neutral-700  text-white hover:bg-transparent transition-all md:text-[17px] text-[15px] hover:scale-110 gap-2 rounded-full md:px-5 md:py-3 py-2 px-4 flex items-center"
          >
        ...
        <div className="flex dark:text-black md:justify-end justify-center md:w-[33.3%] w-[100%]">
          <Link
            className="md:text-[17px] dark:bg-white dark:hover:bg-[#fffb] dark:hover:text-black text-[15px] flex items-center gap-2 md:px-5 md:py-3 py-2 px-4 border-[1px] shadow-sm border-[#00000023] rounded-full hover:bg-black hover:text-white transition-all"
            href={"/about"}
          >
            {" "}
            More about Me <IoMdArrowForward className="text-[20px]" />{" "}
          </Link>
        </div>
      </div>
    </section>
